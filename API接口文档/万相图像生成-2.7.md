...
| **模型名称** | **模型简介** | **输出图像规格** |
| --- | --- | --- |
| wan2.7-image-pro | 万相2.7 image专业版，支持4K高清输出 | 图片格式：PNG。 图像分辨率和尺寸请参见[size参数](https://help.aliyun.com/zh/model-studio/wan-image-generation-api-reference#wan27-param-size-section)。 |
